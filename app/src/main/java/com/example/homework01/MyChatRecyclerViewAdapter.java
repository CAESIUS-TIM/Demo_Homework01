...
import com.example.homework01.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.homework01.databinding.FragmentChatBinding;
...
public class MyChatRecyclerViewAdapter extends RecyclerView.Adapter<MyChatRecyclerViewAdapter.ViewHolder> {
    ...
    public MyChatRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
